...
import 'package:student_management/screens/auth/TimeTable/database.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>TimetablePage()));
          },
        ),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text("Subject code",style: TextStyle(color: Colors.black,fontSize: 24,fontWeight:FontWeight.bold ),),
            ...
            SizedBox(height: 10.0,),
            Text("Time",style: TextStyle(color: Colors.black,fontSize: 24,fontWeight:FontWeight.bold ),),
            SizedBox(height: 10.0,),
            Container(
              padding: EdgeInsets.only(left: 10.0),
              decoration: BoxDecoration(border:Border.all(),borderRadius: BorderRadius.circular(10)),
